        ...
        <div className="container">
          ...
          <ul className="projects">
            ...
            <li className="project">
              ...
              <h5 className="project__description">
                Discord bot that allows you to simulate a chess session. Based
                on Stockfish - the Free Chess Engine with UCI support.
              </h5>
              <a
            ...
            <li className="project">
              ...
              <h5 className="project__description">
                A convenient website that allows the team to choose a convenient
                time for calls.
              </h5>
              <a
                onClick={showMessage}
